...
L.Handler.Draw = L.Handler.extend({
	...
	disable: function () {
		...
		// CUSTOM LLLGEO #returnto 
// this is quick/ugly gui hacking to show user control is on/off
		$(".leaflet-control-draw-rectangle").removeClass("active");
	},
...
L.SimpleShape.Draw = L.Handler.Draw.extend({
	...
	_onMouseDown: function (e) {
		...
		// CUSTOM LLLGEO:
				// we wanna clear any previous shapes
	...
	_onMouseMove: function (e) {
		...
		this._map.fire(
			'draw:drag',
			// we really just want to use these for a ratio
			{
				lat_orig: this._startLatLng.lat,
				lat_new: latlng.lat,
				lng_orig: this._startLatLng.lng,
				lng_new: latlng.lng
			}
...
L.Control.Draw = L.Control.extend({
	...
	onAdd: function (map) {
		...
		if (this.options.rectangle) {
			...
			this.handlers.rectangle.on('activated',function(){

// CUSTOM LLLGEO #returnto 
// this is quick/ugly gui hacking to show user control is on/off
$(".leaflet-control-draw-rectangle").addClass("active");
